import 'package:choreyprototype0712/models/cards.dart';
...
class CardServices {
  ...
  void createCard(
      {String id, String userId, int exp_month, int exp_year, int last4}) {
  ...
  Future<List<CardModel>> getCards({String userId}) async => _firestore
          .collection(collection)
